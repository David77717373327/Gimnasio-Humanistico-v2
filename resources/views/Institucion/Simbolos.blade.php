...
<head>
    ...
    <!-- SEO adicional -->
    <meta name="description" content="Símbolos institucionales, himno oficial y valores del Gimnasio Humanístico de Neiva. Conoce nuestra identidad educativa basada en el humanismo, cultura ambiental y formación integral.">
            ...
            <div class="himno-main-content">
                <div class="himno-intro">
                    ...
                    <p class="himno-intro-text">
                        Compuesto por el Magíster <strong>Jesús María Vidal Arias</strong>, este himno representa los valores del 
                        <strong>humanismo, el trabajo, la cultura ambiental, la inclusión y el sentido de pertenencia</strong>. 
                        Cada estrofa refleja el compromiso con la formación integral y el amor por el territorio del Alto Magdalena.
                    </p>
                </div>
        ...
        <div class="simbolos-container">
                ...
                <div class="simbolo-row">
                    ...
                    <div class="simbolo-content">
                        ...
                        <p class="simbolo-description">
                            El escudo simboliza la unión del ser humano con la naturaleza del territorio del Alto Magdalena. 
                            La silueta del estudiante ubicada en el centro representa la esencia <strong>humanista</strong> de la institución. 
                            El árbol que forma una casa evoca la <strong>cultura ambiental</strong> y la importancia de la familia en la 
            ...
            <div class="simbolo-item">
                <div class="simbolo-row reverse">
                    <div class="simbolo-image-container">
                        <img src="{{ asset('images/bandera.png') }}" alt="Bandera institucional del Gimnasio Humanístico de Neiva" class="simbolo-image bandera-image" loading="lazy">
                    </div>
                    <div class="simbolo-content">
                        <h3 class="simbolo-name">Bandera Institucional</h3>
                        <p class="simbolo-description">
                            La bandera está compuesta por dos colores. El <strong>amarillo</strong> simboliza la riqueza moral e intelectual 
                            que la institución cultiva en cada estudiante para su crecimiento humano.
                        </p>
                        <p class="simbolo-description">
                            El color <strong>verde</strong> representa la esperanza y la conexión del ser humano con la naturaleza, promoviendo 
